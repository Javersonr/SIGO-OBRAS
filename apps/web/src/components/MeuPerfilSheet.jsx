...
export default function MeuPerfilSheet({ open, onOpenChange }) {
  ...
  const handleSavePerfil = async () => {
    ...
    try {
      await sigo.entities.UsuarioEmpresa.update(vinculoAtual.id, perfilForm);
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
                  ...
                  {perfilForm.foto_url ? (
                    <div className="relative">
                      ...
                      <Button
                        ...
                        onClick={() => setPerfilForm((p) => ({ ...p, foto_url: "" }))}
                      >
                        <X className="w-3 h-3" />
                      </Button>
                    </div>
                  ...
                  <label>
                    <Button variant="outline" disabled={uploadingFotoPerfil} asChild>
                      <span className="gap-2">
                        ...
                        {uploadingFotoPerfil ? "Enviando..." : "Upload da Foto"}
                      </span>
                    </Button>
                    <input
                      type="file"
              ...
              <div>
                ...
                <Input
                  value={perfilForm.nome_completo || ""}
                  onChange={(e) => setPerfilForm((p) => ({ ...p, nome_completo: e.target.value }))}
                  className="mt-1.5"
                />
              </div>
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex gap-2">
                    <Input
                      ...
                      onChange={(e) => {
                        setPerfilForm((p) => ({ ...p, cep: e.target.value }));
                    ...
                    <Button
                      variant="outline"
                      onClick={() => handleBuscarCep(perfilForm.cep)}
                      disabled={buscandoCepPerfil}
                    >
                      {buscandoCepPerfil ? "Buscando..." : "Buscar"}
                    </Button>
                  </div>
                  <Input
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <Input
                      ...
                      onChange={(e) => setPerfilForm((p) => ({ ...p, numero: e.target.value }))}
                      placeholder="Nº"
                    />
                    <Input
                      ...
                      onChange={(e) =>
                        setPerfilForm((p) => ({ ...p, complemento: e.target.value }))
                      }
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <Select
                      ...
                      onValueChange={(v) => setPerfilForm((p) => ({ ...p, estado: v }))}
                    >
                      <SelectTrigger>
              ...
              >
                ...
                {savingPerfil ? "Salvando..." : "Salvar Informações"}
              </Button>
            </CardContent>
          </Card>
