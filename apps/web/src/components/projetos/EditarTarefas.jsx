...
export default function EditarTarefas({
  ...
  const handleSalvar = async () => {
    ...
    const dataComum = {
      ...
      responsavel_principal_nome:
        responsavelPrincipal?.nome_completo || responsavelPrincipal?.usuario_email || "",
  ...
  const tarefasDisponiveis = tarefas.filter(
    (t) => t.id !== tarefa?.id && !t.tarefa_pai_id && t.projeto_id === projetoId
  );
    ...
    <>
            ...
            <div className="space-y-4 pb-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Select
                    value={dados.status}
                    onValueChange={(v) => setDados({ ...dados, status: v })}
                  >
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(v) => setDados({ ...dados, prioridade: v })}
                  >
                    <SelectTrigger className="mt-1">
                      <SelectValue />
                    </SelectTrigger>
                    ...
                    <div className="space-y-2">
                      {tarefasDisponiveis.map((t) => (
                        <div key={t.id} className="flex items-center gap-2">
                          ...
                          <Badge
                            variant={t.status === "Concluída" ? "success" : "secondary"}
                            className="text-xs"
                          >
                            {t.status}
                          </Badge>
                    ...
                    <div className="mt-2 space-y-2">
                            ...
                            <div className="flex gap-2 ml-6">
                              <div className="flex-1">
                                ...
                                <Input
                                  ...
                                  onChange={(e) =>
                                    handleEditarDataSubtarefa(sub.id, "data_inicio", e.target.value)
                                  }
                              ...
                              <div className="flex-1">
                                ...
                                <Input
                                  ...
                                  value={sub.data_fim || ""}
                                  onChange={(e) =>
                                    handleEditarDataSubtarefa(sub.id, "data_fim", e.target.value)
                                  }
                                  className="h-8 text-xs mt-1"
                                  disabled={sub.status === "Concluída"}
                                />
                      ...
                      <div className="space-y-2 p-3 border rounded bg-white">
                        <Input
                          ...
                          onKeyDown={(e) =>
                            e.key === "Enter" && !e.shiftKey && handleAdicionarSubtarefa()
                          }
                        />
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <Label className="flex items-center gap-2">
                      ...
                      {despesasVinculadas.length > 0 && (
                        <span className="text-xs font-normal text-slate-500">
                          (
                          {formatCurrency(
                            despesasVinculadas.reduce((s, d) => s + (d.valor || 0), 0)
                          )}
                          )
                        </span>
                      )}
                    ...
                    <Button
                      ...
                      onClick={handleAbrirVincularDespesa}
                    >
                  ...
                  {despesasVinculadas.length === 0 ? (
                    ...
                    <div className="space-y-2">
                      {despesasVinculadas.map((d) => (
                        <div
                          key={d.id}
                          className="flex items-center gap-2 p-2 bg-red-50 border border-red-100 rounded text-sm"
                        >
                          ...
                          <Button
                            ...
                            onClick={() => handleDesvincularDespesa(d)}
                            title="Desvincular"
                          >
                            <X className="w-3 h-3 text-red-500" />
                          </Button>
              ...
              <div>
                ...
                <div className="mt-2 space-y-2">
                  <input
                    ref={(ref) => {
                      if (ref) window.tarefaAnexoInput = ref;
                    }}
                    type="file"
                    className="hidden"
                  ...
                  {dados.anexos.length > 0 && (
                    <div className="space-y-2 mt-2">
                      {dados.anexos.map((anexo, index) => (
                        <div
                          key={index}
                          className="flex items-center gap-2 p-3 bg-slate-50 rounded border hover:bg-slate-100 transition-colors"
                        >
      ...
      <Dialog open={showVincularDespesa} onOpenChange={setShowVincularDespesa}>
        <DialogContent data-fullscreen-modal className="max-w-xl">
            ...
            {loadingDespesas ? (
              ...
              <div className="text-center py-8 text-slate-400">
                ...
                <p className="text-sm">
                  ...
                  <br />
                  Cadastre despesas no financeiro vinculadas a este projeto.
                </p>
              </div>
            ) : (
              despesasDisponiveis.map((d) => (
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => handleVincularDespesa(d)}
                  >
                    Vincular
                  </Button>
                </div>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setShowVincularDespesa(false)}>
              Fechar
            </Button>
          </DialogFooter>
        </DialogContent>
