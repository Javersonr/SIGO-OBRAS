...
export default function ResponsaveisSelect({
  ...
  React.useEffect(() => {
    ...
    if (
      ...
      sorted !== lastExternalRef.current &&
  ...
  return (
    <div className="flex items-center gap-1">
      <div className="flex -space-x-2">
        ...
        {emails.length > 3 && (
          <div
            className={`${avatarSize} rounded-full bg-slate-400 flex items-center justify-center text-xs font-bold text-white border-2 border-white`}
          >
            +{emails.length - 3}
          </div>
        )}
