...
export const gerarListaFerramentalCaminhao = (caminhao, ferramentas, empresa) => {
  ...
  doc.text(`Emitido em: ${format(new Date(), 'dd/MM/yyyy HH:mm', { locale: ptBR })}`, pageW - margin, 18, { align: 'right' });
  ...
  doc.text(`Total de itens: ${total}   |   Disponíveis: ${disponiveis}   |   Valor total: R$ ${valorTotal.toFixed(2)}`, margin, y);
  y += 8;
