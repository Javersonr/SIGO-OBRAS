  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="h-full overflow-hidden p-0 flex flex-row w-full">
              ...
              <div style={{ pageBreakAfter: "always" }}>
                ...
                >
                  <p>
                    ...
                    Trabalho, dando ciência os empregados:
                  </p>
                </div>
                  ...
                  <div style={{ padding: "1.5mm", fontSize: "10pt" }}>
                    ...
                    >
                      <div style={{ borderRight: "1px solid black", padding: "1mm" }}>
                        ...
                        {data.funcao || funcionario.funcao_nome || ""}
                      </div>
                      <div style={{ padding: "1mm" }}>
                        <span style={{ fontWeight: "bold" }}>Setor:</span> {data.setor || ""}
                      </div>
                    </div>
                    <div
                      style={{
                    ...
                    >
                      <span style={{ fontWeight: "bold" }}>Locais de Trabalho:</span>{" "}
                    ...
                    >
                      <span style={{ fontWeight: "bold" }}>Descrição Sumária:</span>{" "}
                      {data.descricao_sumaria || ""}
                    </div>
                    <div style={{ padding: "1mm" }}>
                      <span style={{ fontWeight: "bold" }}>Atividades Desenvolvidas:</span>{" "}
                ...
                <div style={{ border: "1px solid black", marginBottom: "3mm" }}>
                  ...
                  <div style={{ padding: "1.5mm", fontSize: "10pt" }}>
                    ...
                    >
                      <div style={{ borderRight: "1px solid black", padding: "1mm" }}>
                        <span style={{ fontWeight: "bold" }}>Físicos:</span>{" "}
                        {data.agentes_fisicos || ""}
                      </div>
                      <div style={{ padding: "1mm" }}>
                        <span style={{ fontWeight: "bold" }}>Químicos:</span>{" "}
                    ...
                    >
                      <div style={{ borderRight: "1px solid black", padding: "1mm" }}>
                        <span style={{ fontWeight: "bold" }}>Biológicos:</span>{" "}
                        {data.agentes_biologicos || ""}
                      </div>
                      <div style={{ padding: "1mm" }}>
                        <span style={{ fontWeight: "bold" }}>Ergonômicos:</span>{" "}
                        {data.agentes_ergonomicos || ""}
                      </div>
                    </div>
                    <div style={{ padding: "1mm" }}>
                      <span style={{ fontWeight: "bold" }}>Acidentes:</span>{" "}
              ...
              <div style={{ pageBreakAfter: "avoid" }}>
                ...
                <div style={{ border: "1px solid black", marginBottom: "3mm" }}>
                  ...
                  >
                    ...
                    comprometo sempre a cumpri-las durante o exercício do trabalho. Estou ciente que
                    estas instruções são essenciais para a proteção da minha integridade física e
                    saúde, inclusive a de meus colegas de trabalho. Afirmo aqui que a empresa
                    fornece os EPI's necessários ao desempenho seguro das minhas atividades. Sou
                    ciente de que pelo não cumprimento das instruções de segurança ou pela recusa ao
                    uso dos EPI's estará sujeito às punições cabíveis.
                  </div>
                </div>
                ...
                <div style={{ border: "1px solid black", marginBottom: "3mm" }}>
                  <div
                    style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr 1fr 1fr", gap: "0" }}
                  >
                    <div
                      style={{
        ...
        {/* Editor Panel */}
        {showEditor && (
          <OrdemServicoEditorPanel settings={settings} onSettingsChange={setSettings} />
        )}
      </SheetContent>
    </Sheet>
  );
