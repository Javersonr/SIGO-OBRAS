          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={() =>
                              setEtapaForm({
                                ...etapaForm,
                                responsaveis_ids: etapaForm.responsaveis_ids.filter(
                                  (id) => id !== respId
                                ),
                              })
                            }
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) => setEtapaForm({ ...etapaForm, status: v })}
                >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEtapaForm({ ...etapaForm, data_inicio_planejada: e.target.value })
                  }
                  className="mt-1.5"
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEtapaForm({ ...etapaForm, data_fim_planejada: e.target.value })
                  }
                  className="mt-1.5"
                  placeholder="dd/mm/aaaa"
                />
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select
                  value={etapaForm.prioridade}
                  onValueChange={(v) => setEtapaForm({ ...etapaForm, prioridade: v })}
                >
                  <SelectTrigger className="mt-1.5">
                    <SelectValue />
                  </SelectTrigger>
