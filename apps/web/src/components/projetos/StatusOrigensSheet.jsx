...
export default function StatusOrigensSheet({
  open,
  onOpenChange,
  statusList,
  origensList,
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="h-full overflow-y-auto p-0 flex flex-col">
        <div className="sticky top-0 bg-white border-b p-6 z-10 flex-shrink-0">
          <SheetHeader>
            <SheetTitle>Gerenciar Status e Origens</SheetTitle>
          </SheetHeader>
        </div>
                ...
                <CardContent className="p-4 space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setStatusForm((p) => ({ ...p, nome: e.target.value }))}
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setStatusForm((p) => ({ ...p, cor: e.target.value }))}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setStatusForm((p) => ({ ...p, ordem: parseInt(e.target.value) || 0 }))
                        }
                        className="mt-1.5"
                      />
                    </div>
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(v) => setStatusForm((p) => ({ ...p, tipo: v }))}
                      >
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mt-1.5">
                      <Input
                        ...
                        placeholder="Ex: Indicação, Site, Licitação..."
                      />
                      <Button
                        onClick={handleCriarOrigem}
