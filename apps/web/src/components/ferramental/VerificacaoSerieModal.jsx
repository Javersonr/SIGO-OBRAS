          ...
          <Card className="p-3 bg-amber-50 border-amber-200">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm">
                <p className="font-medium text-amber-900">Esta ferramenta possui número de série cadastrado</p>
                <p className="text-xs text-amber-700 mt-1">Confirme o número de série no equipamento para validação</p>
              </div>
            </div>
          </Card>
        )}
