...
export default function UsuarioEditModal({ 
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full sm:w-[600px] h-full overflow-y-auto p-0 flex flex-col">
                  ...
                  <PopoverContent className="w-[400px] p-0" align="start">
                    <Command>
                      ...
                      <CommandList>
                        ...
                        <CommandGroup>
                          {projetos
                            .filter(p => !searchProjeto || p.nome?.toLowerCase().includes(searchProjeto.toLowerCase()))
                            .map(p => (
                              <CommandItem
                                key={p.id}
                                value={p.nome}
                              ...
                              >
                                <div className="flex flex-col">
                                  ...
                                  {p.cliente_nome && <span className="text-xs text-slate-500">{p.cliente_nome}</span>}
                                </div>
                              </CommandItem>
                            ))}
                        </CommandGroup>
            ...
            {form.perfil === 'Admin' ? (
              <div className="p-8 text-center bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="text-sm text-green-700">
                  Usuários com perfil Admin têm acesso irrestrito a todos os módulos e funcionalidades
                </p>
              </div>
            ) : form.perfil === 'Cliente' ? (
              <div className="p-8 text-center bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <p className="text-sm text-blue-700">
                  Usuários com perfil Cliente só podem visualizar o portal do cliente com as informações do projeto
                </p>
                <div className="mt-4 text-left bg-white rounded-lg p-4">
                  <p className="text-xs font-semibold text-slate-600 mb-2">O que clientes podem ver:</p>
