  ...
  return (
    ...
    >
      ...
      >
        ...
        <button onClick={onFechar} onMouseDown={e => e.stopPropagation()} className="ml-1 hover:text-red-300 transition-colors">
          <X className="w-4 h-4" />
        </button>
      </div>
      ...
      <div
        ...
        onMouseDown={(e) => {
          ...
          const onMove = (ev) => setSize({ w: Math.max(280, startW + ev.clientX - startX), h: Math.max(200, startH + ev.clientY - startY) });
