    ...
    <Card className="border-blue-200 bg-blue-50/40">
      <CardHeader className="pb-2 pt-3 px-4">
        <CardTitle className="text-sm flex items-center justify-between">
          ...
          <Badge
            className={
              totalPreenchidos === campos.length
      ...
      <CardContent className="px-4 pb-4 space-y-2">
        {campos.map((campo) => {
          ...
          const ferrsFiltradas = ferramentasParaVincular.filter((f) => !vinculadas.includes(f.id));
                      ...
                      {ferrsFiltradas.length === 0 ? (
                        ...
                        <table className="w-full text-xs">
                          <thead className="bg-slate-100 border-b sticky top-0">
                            <tr>
                              <th className="px-2 py-1.5 text-left font-semibold text-slate-600 whitespace-nowrap">
                                Sub-Código
                              </th>
