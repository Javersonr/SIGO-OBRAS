  ...
  const handleSave = async () => {
   ...
   try {
     ...
     if (!usuario) {
       ...
       const result = await base44.functions.invoke('criarUsuarioComSenha', {
       ...
       await base44.functions.invoke('criarUsuarioComSenha', {
         usuario_email: form.email,
         senha: form.senha,
         apenas_senha: true
       });
          ...
          <TabsContent value="dados" className="space-y-4 py-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder={usuario ? 'Deixe em branco para não alterar' : 'Defina uma senha para o usuário'}
                className="mt-1.5"
              />
              {!usuario && (
                <p className="text-xs text-slate-500 mt-1">O usuário poderá alterar a senha depois em "Meu Perfil"</p>
              )}
            </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    {form.perfil === 'Admin Holding' ? '📊 Admin Holding: Acesso consolidado a todas as empresas do grupo' : ''}
                  </p>
                </div>
                ...
                {form.perfil === 'Admin Holding' && (
                  <div>
                    ...
                    <Input
                      ...
                      className="mt-1.5"
                    />
                    <p className="text-xs text-slate-500 mt-1">Preencha o ID do grupo para acesso consolidado</p>
                  </div>
                )}
              </div>
            </div>
              ...
              {modulosLiberados.length > 0 ? (
                <>
                  <p className="text-xs text-slate-500 mb-3">
                    Módulos liberados para esta empresa: <strong>{modulosLiberados.join(', ')}</strong>
                  </p>
