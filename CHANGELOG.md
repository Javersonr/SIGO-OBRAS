...
- Wrapper `@sigoobras/sdk` que preserva a API do SDK legado e conversa com Supabase
- Frontend Vite + React 18 (412 componentes, importados do snapshot da plataforma anterior)
...
- Importação dos dados produtivos das ~13 empresas a partir do dump da plataforma anterior
