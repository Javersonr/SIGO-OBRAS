            ...
            >
              ...
              <div style={{ marginBottom: "16px", fontSize: "11px" }}>
                <div style={{ marginBottom: "4px" }}>
                  ...
                  <span
                    style={{ backgroundColor: "#ffff00", padding: "2px 4px", fontWeight: "bold" }}
                  >
              ...
              <div style={{ marginBottom: "16px", fontSize: "10px", lineHeight: "1.6" }}>
                ...
                <div style={{ marginBottom: "12px" }}>
                  <p style={{ fontWeight: "bold", marginBottom: "4px" }}>
                    Norma Regulamentadora 03-NR-3-Embargo ou Interdição
                  </p>
                  <p style={{ textAlign: "justify" }}>
                    3.1.1 Considera – se grave e iminente risco toda condição ou situação de
                    trabalho que possa causar acidente ou doença relacionado ao trabalho com lesão
                ...
                <div style={{ marginBottom: "12px" }}>
                  <p style={{ fontWeight: "bold", marginBottom: "4px" }}>
                    Norma Regulamentadora 09 NR – 9 Programa de Prevenção de Riscos Ambientais
                  </p>
                  <p style={{ textAlign: "justify" }}>
                    ...
                    comunicando o fato ao supervisor hierárquico direto para as devidas
                    providências.
                  </p>
                </div>
                ...
                <div style={{ marginBottom: "12px" }}>
                  <p style={{ fontWeight: "bold", marginBottom: "4px" }}>
                    Norma regulamentadora 10 NR – 10 Segurança em Instalação e Serviços em
                    Eletricidade
                  </p>
                  <p style={{ textAlign: "justify" }}>
                    ...
                    segurança e saúde ou a de outras pessoas, comunicando imediatamente o fato ao
                    supervisor hierárquico, que diligenciará as medidas cabíveis.
                  </p>
                </div>
                ...
                <div style={{ marginBottom: "12px" }}>
                  ...
                  <p style={{ textAlign: "justify" }}>35.2.2 Cabe aos trabalhadores;</p>
                  <p style={{ textAlign: "justify", paddingLeft: "10px" }}>
                    e) interromper suas atividades exercendo o direito de recusa, sempre que
                    constatarem evidências de risco grave e iminentes para sua segurança e saúde ou
                    a de outras pessoas, comunicando imediatamente o fato ao seu superior
                ...
                <div style={{ marginBottom: "12px" }}>
                  <p style={{ fontWeight: "bold", marginBottom: "4px" }}>
                    Organização Internacional do trabalho (OIT) Convenção Nº 155 – Segurança e Saúde
                    dos Trabalhadores
                  </p>
                  <p style={{ textAlign: "justify" }}>
                    De conformidade com a prática e as condições nacionais, deverá proteger – se de
                    consequências injustificada a todo trabalhador que julgar necessário interromper
                    uma situação de trabalho por acreditar, por motivos razoáveis, que este envolve
                    perigo iminente para sua vida ou sua saúde "Artigo 13"
                  </p>
                </div>
                ...
                <div style={{ marginBottom: "12px" }}>
                  ...
                  <p style={{ textAlign: "justify" }}>
                    Declaro que tomei ciência da constatação da situação de risco grave e iminente
                    relatada durante o exercício das atividades. Poderei submeter a realização
                    dessas atividades comunicando imediatamente tal fato ao supervisor hierárquico,
                    bem como apresentar a recusa formal, prevista e sustentada pela legislação
                    vigente do Ministério do Trabalho e Emprego, inclusive a Convenção 155 da
                    Organização Internacional do Trabalho que garante e ampara a minha integridade
                    física, bem como a dos demais colegas envolvidos e a dos terceiros próximos.
                  </p>
                </div>
              </div>
                ...
                >
                  <div>
                    ...
                    <div style={{ marginBottom: "8px" }}>
                      <p style={{ fontWeight: "bold" }}>
                        Nome:{" "}
                        <span style={{ backgroundColor: "#ffff00", padding: "2px 4px" }}>
                          {funcionario.nome_completo?.toUpperCase() || ""}
                        </span>
                      </p>
                      <p style={{ marginTop: "4px" }}>
                        Função: {funcionario.funcao_nome?.toUpperCase() || ""}
                      </p>
                  ...
                  <div>
                    ...
                    <div style={{ marginBottom: "8px" }}>
                      <p style={{ fontWeight: "bold" }}>
                        Nome:{" "}
                        {funcionario.responsavel_tecnico_nome || "Javerson Rodrigues da Silva"}
                      </p>
