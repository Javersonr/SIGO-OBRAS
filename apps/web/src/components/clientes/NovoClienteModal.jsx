...
const FORM_INICIAL = {
  nome_razao: '', nome_fantasia: '', documento: '', tipo_pessoa: 'PJ',
  contato_email: '', contato_telefone: '', endereco: '', numero: '',
  complemento_bairro: '', cidade: '', estado: '', cep: '', contato_principal: '', observacoes: ''
};
...
export default function NovoClienteModal({ open, onOpenChange, empresaAtiva, onClienteCriado }) {
  ...
  return (
    <Sheet open={open} onOpenChange={handleClose}>
      <SheetContent side="right" className="h-full overflow-y-auto p-0 flex flex-col max-w-2xl lg:max-w-none lg:w-[calc(100%-256px)]" data-fullscreen-modal>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <Input value={form.nome_fantasia} onChange={(e) => setForm({ ...form, nome_fantasia: e.target.value })} placeholder="Nome fantasia da empresa" className="mt-1.5" />
            </div>
            <div>
              <Label>Tipo *</Label>
            ...
            <div>
              ...
              <Input 
                ...
                onChange={(e) => {
                  const formatted = form.tipo_pessoa === 'PF' ? formatCPF(e.target.value) : formatCNPJ(e.target.value);
          ...
          <div className="border-t pt-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label>E-mail</Label>
                <Input type="email" value={form.contato_email} onChange={(e) => setForm({ ...form, contato_email: e.target.value })} placeholder="email@exemplo.com" className="mt-1.5" />
              </div>
              <div>
                <Label>Telefone</Label>
                <Input value={form.contato_telefone} onChange={(e) => setForm({ ...form, contato_telefone: e.target.value })} placeholder="(00) 00000-0000" className="mt-1.5" />
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="col-span-2">
                  ...
                  <Input value={form.complemento_bairro} onChange={(e) => setForm({ ...form, complemento_bairro: e.target.value })} placeholder="Apto 101, Centro" className="mt-1.5" />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
          ...
          <div>
            ...
            <Textarea value={form.observacoes} onChange={(e) => setForm({ ...form, observacoes: e.target.value })} placeholder="Informações adicionais sobre o cliente..." className="mt-1.5" rows={3} />
          </div>
        </div>
