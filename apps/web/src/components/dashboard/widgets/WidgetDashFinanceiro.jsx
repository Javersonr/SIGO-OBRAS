      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <Card className="border-l-4 border-l-green-500">
          <CardContent className="p-3">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-slate-500">Receitas Mês</p>
                <p className="text-xl font-bold text-green-600">{fmt(data.receitasMes)}</p>
              </div>
        ...
        <Card className="border-l-4 border-l-red-500">
          <CardContent className="p-3">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-slate-500">Despesas Mês</p>
                <p className="text-xl font-bold text-red-600">{fmt(data.despesasMes)}</p>
              </div>
        ...
        <Card
          className={`border-l-4 ${data.saldoMes >= 0 ? "border-l-blue-500" : "border-l-orange-500"}`}
        >
          <CardContent className="p-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p
                  className={`text-xl font-bold ${data.saldoMes >= 0 ? "text-blue-600" : "text-orange-600"}`}
                >
                  {fmt(data.saldoMes)}
                </p>
              </div>
          ...
          <CardContent className="p-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-red-700">{fmt(data.valorVencidos)}</p>
              </div>
