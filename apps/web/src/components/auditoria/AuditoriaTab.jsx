                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-slate-500 space-y-1">
                      <p>👤 {log.usuario_nome} ({log.usuario_email})</p>
            ...
            <>
              ...
              <div className="space-y-6 py-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label className="text-xs text-slate-500">Status</Label>
                    <Badge className={selectedLog.status === 'sucesso' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'} style={{ marginTop: '0.5rem' }}>
                      {selectedLog.status}
                    </Badge>
                  </div>
                </div>
                ...
                {selectedLog.endereco_ip && (
                  <div>
                    ...
                    <p className="text-slate-800 mt-1 font-mono text-sm">{selectedLog.endereco_ip}</p>
                  </div>
                )}
