...
export default function KpiCard({ titulo, valor, subtitulo, icon: Icon, cor = 'blue', tendencia, tendenciaValor }) {
  const cores = {
  ...
  const tendCor = tendencia === 'up' ? 'text-green-600' : tendencia === 'down' ? 'text-red-500' : 'text-slate-400';
