          ...
          ferramentaIds.map((fid) =>
            base44.entities.Ferramenta.update(fid, {
              ...
              ...(form.proxima_manutencao_prevista
                ? { proxima_manutencao: form.proxima_manutencao_prevista }
                : {}),
            })
          )
        );
    ...
    >
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Select
              ...
              onValueChange={(v) => setForm({ ...form, tipo_manutencao: v })}
            >
        ...
        <div>
          ...
          <Input
            type="date"
            value={form.proxima_manutencao_prevista}
            onChange={(e) => setForm({ ...form, proxima_manutencao_prevista: e.target.value })}
            className="mt-1.5"
          />
        </div>
