        ...
        <div className="p-6 flex-1 overflow-y-auto space-y-6">
          <div>
            ...
            <p className="text-xs text-slate-500 mb-3">
              Clique nos projetos para selecionar/deselecionar.
            </p>
            {projetos.length === 0 ? (
            ...
            {projetosSelecionados.length > 0 && (
              <p className="text-sm text-blue-600 font-medium mt-3">
                ...
                {projetosSelecionados.length * saldosValidos.length} reserva(s) serão criadas
              </p>
            )}
          </div>
                ...
                <div key={saldo.id} className="flex items-center gap-2 text-sm text-slate-600">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-slate-400 ml-2">
                      {saldo.material_codigo} • Disponível: {saldo.quantidade_disponivel}{" "}
                      {saldo.unidade}
                    </span>
                  </div>
                </div>
