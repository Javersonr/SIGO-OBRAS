...
export function salvarFotoOffline(fotoDataUrl, metadata) {
  ...
  fotos.push({ id: Date.now(), dataUrl: fotoDataUrl, metadata, timestamp: new Date().toISOString(), enviada: false });
...
export default function DiarioCameraModal({ open, onOpenChange, onFotosSalvas, projetoId, empresaId }) {
