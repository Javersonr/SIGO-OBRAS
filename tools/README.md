...
Script para exportar TUDO do Base44 (100 entidades, dados, arquivos). Útil para snapshot completo antes do cutover.
...
Importa o backup multi-empresa `backup_todas_empresas_*.xlsx` direto para o Supabase. Cada aba do xlsx tem o padrão `<NomeEmpresa>_<NomeEntidade>`. O script faz upsert preservando os IDs do Base44, agrupando por empresa.
...
4. Mantém os UUIDs originais do Base44 (campo `id`) para preservar FKs
