...
export default function DRERelatorio({
  ...
  const LinhaRelatorio = ({ label, valor, destaque = false, negrito = false, identacao = 0 }) => (
    ...
    >
      ...
      <span
        className={`${negrito ? "font-bold" : "font-medium"} ${valor < 0 ? "text-red-600" : "text-slate-900"}`}
      >
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-1">
        ...
        <LinhaRelatorio
          label="(-) Custos Variáveis (Materiais)"
        ...
        <div className="mt-6 p-4 bg-slate-50 rounded-lg">
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              ...
              <p
                className={`text-lg font-bold ${lucroLiquido >= 0 ? "text-green-600" : "text-red-600"}`}
              >
